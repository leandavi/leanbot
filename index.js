	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Olá @${num.split('@')[0]}\nBem vindo ao grupo seu lindo(a) *${mdata.subject}*\n\nEspero que goste dessa merda não seja ghost ❤️`
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD LEAN⁷$x BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗]    么DΛVID⁴⁴⁴文🥶 ? Este é um recurso especial para o 么DΛVID⁴⁴⁴文🥶 ❌',
					ownerB: '[❗]    么DΛVID⁴⁴⁴文🥶 ? Este é um recurso especial para o 么DΛVID⁴⁴⁴文🥶 ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de 么DΛVID⁴⁴⁴文🥶 . Registre-se para fazer amizade com o bot TOBIZIN por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar TOBIZIN|17\n\n──「 TOBIZIN BOT 」──`,
